 ...
 * @author sammy
 */
public class ErroTransacaoNegada extends javax.swing.JFrame {
    ...
    public ErroTransacaoNegada(ContaBanco conta) {
        this.conta = conta;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Transação Negada");
...
//
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ErroTransacaoNegada(new ContaBanco()).setVisible(true);
            }
        });
    }
